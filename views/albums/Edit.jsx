...
class Edit extends React.Component {
    render(){
        const { _id, albumTitle, img, song1title, song2title, song3title, song4title, song5title, song6title, song7title, song8title, song9title, song10title, song1length, song2length, song3length, song4length, song5length, song6length, song7length, song8length, song9length, song10length, song1file, song2file, song3file, song4file, song5file, song6file, song7file, song8file, song9file, song10file} = this.props.album; 
        return (
            <div>
                <h1>Edit Page</h1>
                ...
                <input class='song1file' type='text' name='song1file' defaultValue={song1file}/><br/>
                ...
                <input class='song2file' type='text' name='song2file' defaultValue={song2file}/><br/>
                ...
                <input class='song3file' type='text' name='song3file' defaultValue={song3file}/><br/>
                ...
                <input class='song4file' type='text' name='song4file' defaultValue={song4file}/><br/>
                ...
                <input class='song5file' type='text' name='song5file' defaultValue={song5file}/><br/>
                ...
                <input class='song6file' type='text' name='song6file' defaultValue={song6file}/><br/>
                ...
                <input class='song7file' type='text' name='song8file' defaultValue={song8file}/><br/>
                ...
                <input class='song8file' type='text' name='song8file' defaultValue={song8file}/><br/>
                ...
                <input class='song9file' type='text' name='song9file' defaultValue={song9file}/><br/>
                ...
                <input class='song10file' type='text' name='song10file' defaultValue={song10file}/><br/>
